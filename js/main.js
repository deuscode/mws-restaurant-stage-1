...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiZGV1c2NvZGU4NyIsImEiOiJjamp1OGt2YjAwczZxM3ZtODZseG5tMGF4In0.0T_hj_EA6CJyioxgjMLQYg',
    maxZoom: 18,
 ...
 */
 ...
 if (navigator.serviceWorker) {
  ...
  .then(registration => {
    console.log(`Service Worker has successfuly registered`);
  }).catch(error => {
